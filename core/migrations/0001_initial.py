# Generated by Django 3.2.8 on 2021-12-10 14:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(blank=True, choices=[('Post Remove', 'Post Remove'), ('Account Ban', 'Account Ban'), ('Account Delete', 'Account Delete')], max_length=20)),
                ('is_review', models.BooleanField(blank=True, default=False)),

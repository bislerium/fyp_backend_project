# Generated by Django 3.2.8 on 2021-11-26 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reacted_by', models.ManyToManyField(blank=True, to='core.NormalUser')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('down_vote', models.ManyToManyField(blank=True, related_name='down_vote', to='core.NormalUser')),
                ('post', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.post')),
                ('reported_by', models.ManyToManyField(blank=True, related_name='reported_by', to='core.NormalUser')),
                ('up_vote', models.ManyToManyField(blank=True, related_name='up_vote', to='core.NormalUser')),
            ],
            options={
                'abstract': False,
            },
